...
#define HID_DEMO_TAG "BleHidService"
...
static const char* unitName = NULL;
    ...
    switch(event) {
        case ESP_HIDD_EVENT_REG_FINISH: {
            if (param->init_finish.state == ESP_HIDD_INIT_OK) {
                ...
                esp_ble_gap_set_device_name(unitName);
...
bool startBleHidService()
{
    ...
    // set the security iocap & auth_req & key size & init key response
    // key parameters to the stack
    // 
    ...
    // If your BLE device act as a master, the response key means you hope
